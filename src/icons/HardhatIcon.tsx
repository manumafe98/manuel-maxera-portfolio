...
export const HardhatIcon = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="51" height="41" {...props}>
      <path
        fill="#FFF100"
      ...
      <path
        fill="#4B4D4D"
        d="M25.848 10.417v12.306l5.345-3.284-5.345-9.022Zm0 14.093v4.291c.1-.142 5.345-7.58 5.345-7.583l-5.345 3.293Z"
      />
      <path
        fill="#0A0A0A"
        d="m25.848 24.512-5.346-3.288 5.346 7.58V24.51v.002Z"
      />
      <defs>
        <linearGradient
          id="a"
