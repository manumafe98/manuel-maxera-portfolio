...
export const SublimeDialogComponent = forwardRef<
  HTMLDialogElement,
  DialogProps
>(({ onClose }, ref) => {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full h-10 bg-ubuntu-navbar border-b border-solid border-black">
        ...
        <button
          className="flex items-center justify-center w-6 h-6 rounded-full mx-3 bg-ubuntu-orange hover:bg-ubuntu-orange/80 focus:outline-none"
