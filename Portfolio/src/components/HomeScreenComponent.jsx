...
import { LeftArrowIcon, RightArrowIcon, UnfilledArrowRightIcon, XMarkIcon } from "../constants/Icons";
  ...
  return (
    <>
      ...
      <section className="h-screen w-screen overflow-hidden relative">
        ...
        <VsCodeDialogComponent ref={openVsCodeDialogRef} onClose={closeDialog}/>
        <SublimeDialogComponent ref={openSublimeDialogRef} onClose={closeDialog}/>
        <UbuntuSoftwareDialogComponent ref={openUbuntuSoftwareDialogRef} onClose={closeDialog}/>
        <FileManagerDialogComponent ref={openFileManagerDialogRef} onClose={closeDialog}/>
