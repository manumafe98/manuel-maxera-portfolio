    ...
    <>
      ...
      <div className="flex items-center justify-center my-auto min-h-full">
        <div className="text-center">
          ...
          <p className="text-gray-500 italic">The following Portfolio is meant to be used in computers or notebooks</p>
          <p className="text-gray-500 mt-2 italic">As it imitates an Ubuntu Desktop</p>
        </div>
      </div>
    </>
  )
